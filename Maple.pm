...
BEGIN {
	...
	our @ISA    = qw(Exporter);
	our @EXPORT = qw(MAPLE_CMD_DEVINFO MAPLE_CMD_ALLINFO MAPLE_CMD_RESET 
	                 MAPLE_CMD_SHUTDOWN MAPLE_RESP_DEVINFO MAPLE_RESP_DEVINFOEX
	                 MAPLE_RESP_ACK MAPLE_RESP_DATAXFER MAPLE_CMD_GETCOND
	                 MAPLE_CMD_GETMEMINFO MAPLE_CMD_READBLOCK MAPLE_CMD_WRITEBLOCK 
	                 MAPLE_CMD_SYNCBLOCK MAPLE_CMD_SETCOND MAPLE_CMD_MICROPHONE
	                 MAPLE_CMD_CAMERA MAPLE_RESP_ERR MAPLE_RESP_BADFUNC
	                 MAPLE_RESP_BADCMD MAPLE_RESP_AGAIN MAPLE_RESP_FILEERR
	                 MAPLE_FUNC_CONTROLLER MAPLE_FUNC_MEMORY MAPLE_FUNC_LCD
	                 MAPLE_FUNC_CLOCK MAPLE_FUNC_MICROPHONE MAPLE_FUNC_AR_GUN
	                 MAPLE_FUNC_KEYBOARD MAPLE_FUNC_LIGHT_GUN MAPLE_FUNC_PURU_PURU
	                 MAPLE_FUNC_MOUSE MAPLE_FUNC_CAMERA send_maple_packet);
}
